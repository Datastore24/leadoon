...
#pragma marc - constructorScrollView
    ...
    [self getApiOrder:^{
        ...
        UILabel* labelHeaderItems = [[UILabel alloc] initWithFrame:CGRectMake(125, 130 + self.textFieldCommentsHeight, 70, 20)];
        ...
        for (int i = 0; i < self.parseItems.count; i++) {
            ...
            CGRectMake(15, 180 + self.textFieldCommentsHeight + self.labelNameItemsHeight * i , 160, self.labelNameItemsHeight)];
            ...
            CGRectMake(200, 180 + self.textFieldCommentsHeight + self.labelNameItemsHeight * i, 150, self.labelNameItemsHeight)];
            ...
            CGRectMake(240, 180 + self.textFieldCommentsHeight + self.labelNameItemsHeight * i, 150, self.labelNameItemsHeight)];
        ...
        //Высота всех товаров--------------------------------------------------------------------
        self.heightAllItems = 180 + self.textFieldCommentsHeight + self.labelNameItemsHeight * self.parseItems.count;
